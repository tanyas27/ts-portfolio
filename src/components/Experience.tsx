    ...
    <section id="experience" className="py-32 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          {/* Timeline line */}
          <div className="absolute left-0 md:left-8 top-0 bottom-0 w-px bg-gradient-to-b from-[var(--accent)]/50 via-[var(--accent)]/20 to-transparent" />
          ...
          <div className="space-y-12">
            {experience.map((job, i) => (
              ...
              >
                ...
                <div className="glow-border p-6 rounded-2xl bg-[var(--surface)] border border-white/5 transition-all duration-300 hover:-translate-y-1">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-3">
                    <div>
                      <h4 className="text-lg font-semibold text-[var(--foreground)]">
                        {job.role}
                      </h4>
                      <p className="text-[var(--accent-light)] font-medium text-sm">
                        {job.company}
                      </p>
                    </div>
                    <span className="font-mono text-xs text-[var(--text-muted)] bg-white/5 px-3 py-1 rounded-full shrink-0">
                      {job.period}
                    </span>
                  </div>
